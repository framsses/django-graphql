...
SECRET_KEY = 't*85vm!^t8v&^))i@p-c1gal!cgl(%c+=xko6nmp^o@-fa7#c*'
...
MIDDLEWARE = [
    ...
    'graphql_jwt.middleware.JSONWebTokenMiddleware', # Add this information to the MIDDLEWARE
]
...
GRAPHENE = {
    ...
    # Add an S at the end of MIDDLEWARE
    'MIDDLEWARES': [
